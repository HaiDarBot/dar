...
//
const BotName = 'DAR'; // Nama Bot Whatsapp
const instagramlu = 'https://www.instagram.com/oni_15__'; // Nama Instagramlu cok
const whatsapplu = 'Wa.me/+6289673762275'; // Nomor whatsapplu cok
const kapanbotaktif = 'Bot Aktif saat dinyalakan'; // Kapan bot lu aktif
const grupch1 = 'https://chat.whatsapp.com/D2D8g0Wt6xwA1D45gKTAUU'; // OFFICIAL GRUP LU 1
...
conn.on('user-presence-update', json => console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @oni_15__`))
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @oni_15__`)
})
